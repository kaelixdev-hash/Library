...
local redzlib = {
	Themes = {
		...
		Green = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(1, 23, 8)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(1, 23, 8)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(46, 46, 46,))
			}),
			["Color Hub 2"] = Color3.fromRGB(83, 170, 134),
			["Color Stroke"] = Color3.fromRGB(40, 40, 40),
		    ["Color Button"] = Color3.fromRGB(39, 80, 63),
